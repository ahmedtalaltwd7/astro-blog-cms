...
import { manifest } from './manifest_GBzw_GrW.mjs';
...
const _page3 = () => import('./pages/api/delete-post.astro.mjs');
const _page4 = () => import('./pages/api/get-post.astro.mjs');
const _page5 = () => import('./pages/api/hero-settings.astro.mjs');
const _page6 = () => import('./pages/api/list-posts.astro.mjs');
const _page7 = () => import('./pages/api/save-post.astro.mjs');
const _page8 = () => import('./pages/api/upload-editor-image.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/delete-post.js", _page3],
    ["src/pages/api/get-post.js", _page4],
    ["src/pages/api/hero-settings.js", _page5],
    ["src/pages/api/list-posts.js", _page6],
    ["src/pages/api/save-post.js", _page7],
    ["src/pages/api/upload-editor-image.js", _page8],
