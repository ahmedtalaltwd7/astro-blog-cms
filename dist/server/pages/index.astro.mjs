/* empty css                                 */
import { e as createComponent, k as renderComponent, r as renderTemplate, h as createAstro, m as maybeRenderHead, g as addAttribute } from '../chunks/astro/server_CPVj0fOm.mjs';
import 'piccolore';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": heroConfig.pageTitle, "description": heroConfig.metaDescription }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="min-h-screen"> <!-- Hero Section --> <section class="py-20"${addAttribute(heroStyle, "style")}> <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"> <h1 class="text-5xl md:text-6xl font-bold mb-6"> ${heroConfig.title} </h1> <p class="text-xl md:text-2xl mb-10 max-w-3xl mx-auto"> ${heroConfig.subtitle} </p> <div class="flex flex-col sm:flex-row gap-4 justify-center"> <a${addAttribute(heroConfig.primaryButtonHref, "href")} class="inline-flex items-center justify-center px-8 py-3 border border-transparent text-lg font-medium rounded-md text-blue-700 bg-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white"> <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path> </svg> ${heroConfig.primaryButtonText} </a> <a${addAttribute(heroConfig.secondaryButtonHref, "href")} class="inline-flex items-center justify-center px-8 py-3 border border-current text-lg font-medium rounded-md hover:bg-white hover:text-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white"> <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path> </svg> ${heroConfig.secondaryButtonText} </a> </div> </div> </section> <!-- Features Section --> <section class="py-16 bg-white"> <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> <h2 class="text-3xl font-bold text-center text-gray-900 mb-12">
How It Works
...
View all posts
<svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path> </svg> </a> </div> ${latestPosts.length > 0 ? renderTemplate`<div class="grid grid-cols-1 md:grid-cols-3 gap-8"> ${latestPosts.map((post) => renderTemplate`<article class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300"> ${post.frontmatter.thumbnail || post.frontmatter.image ? renderTemplate`<img${addAttribute(post.frontmatter.thumbnail || post.frontmatter.image, "src")}${addAttribute(post.frontmatter.title, "alt")} class="w-full h-48 object-cover">` : renderTemplate`<div class="h-48 bg-gradient-to-r from-blue-400 to-purple-500"></div>`} <div class="p-6"> <div class="text-sm text-gray-500 mb-3"> <time${addAttribute(post.frontmatter.pubDate, "datetime")}> ${post.frontmatter.pubDate} </time> </div> <h3 class="text-xl font-bold text-gray-900 mb-3"> <a${addAttribute(`/blog/${post.slug}`, "href")} class="hover:text-blue-600"> ${post.frontmatter.title} </a> </h3> <p class="text-gray-600 mb-4"> ${post.frontmatter.description || "No description provided."} </p> <a${addAttribute(`/blog/${post.slug}`, "href")} class="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium">
Read more
