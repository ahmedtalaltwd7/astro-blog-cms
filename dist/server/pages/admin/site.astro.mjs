...
const $$Site = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Admin Panel - Header and Footer" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "AdminControlNav", $$AdminControlNav, { "active": "site" })} ${renderComponent($$result2, "SiteChromeAdmin", SiteChromeAdmin, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Ahmed Talal/Desktop/astro-blog/src/components/SiteChromeAdmin.jsx", "client:component-export": "default" })} ` })}`;
