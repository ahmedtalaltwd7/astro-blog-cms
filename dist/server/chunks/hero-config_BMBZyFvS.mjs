...
function normalizeHeroConfig(value = {}) {
  ...
  return {
    ...
    metaDescription: String(config.metaDescription || config.subtitle || DEFAULT_HERO_CONFIG.metaDescription).trim(),
    ...
    primaryButtonText: String(config.primaryButtonText || DEFAULT_HERO_CONFIG.primaryButtonText).trim(),
    primaryButtonHref: normalizeUrl(config.primaryButtonHref, DEFAULT_HERO_CONFIG.primaryButtonHref),
    secondaryButtonText: String(config.secondaryButtonText || DEFAULT_HERO_CONFIG.secondaryButtonText).trim(),
    secondaryButtonHref: normalizeUrl(config.secondaryButtonHref, DEFAULT_HERO_CONFIG.secondaryButtonHref),
    backgroundType: backgroundTypes.has(config.backgroundType) ? config.backgroundType : DEFAULT_HERO_CONFIG.backgroundType,
    backgroundColor: normalizeHexColor(config.backgroundColor, DEFAULT_HERO_CONFIG.backgroundColor),
    gradientFrom: normalizeHexColor(config.gradientFrom, DEFAULT_HERO_CONFIG.gradientFrom),
    ...
    overlayColor: normalizeHexColor(config.overlayColor, DEFAULT_HERO_CONFIG.overlayColor),
    overlayOpacity: Math.min(90, Math.max(0, Number(config.overlayOpacity) || DEFAULT_HERO_CONFIG.overlayOpacity))
  };
}
...
async function writeHeroConfig(config) {
...
export { normalizeHeroConfig as n, readHeroConfig as r, writeHeroConfig as w };
