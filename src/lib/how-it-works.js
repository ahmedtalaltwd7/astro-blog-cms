...
export function getHowItWorksPath() {
...
function normalizeCard(card, index) {
  ...
  return {
    ...
    accentBackgroundColor: normalizeHexColor(
      card?.accentBackgroundColor,
      fallback.accentBackgroundColor,
    ),
...
export function normalizeHowItWorks(value = {}) {
  ...
  return {
    ...
    cards: cards
      ...
      .filter((card) => card.title || card.body || card.backgroundImageUrl)
      .slice(0, 12),
  };
}
